...
add wave -noupdate /DE1_SOC_testbench/dut/soft_reset
...
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/l
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/r
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/nl
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/nr
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/light_on
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/ps
add wave -noupdate -expand -group {LEDR[4]} /DE1_SOC_testbench/dut/nl4/ns
...
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/l
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/r
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/nl
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/nr
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/light_on
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/ps
add wave -noupdate -expand -group {LEDR[6]} /DE1_SOC_testbench/dut/nl6/ns
...
WaveRestoreCursors {{Cursor 1} {818 ps} 0}
